...
NEW_CHAT_MEMBER = """Привет, {user_as_hlink}!

Добро пожаловать в сообщество «В погоне за пампом»!

Здесь ты можешь
- Записаться на еженедельную тренировку
- Поделиться любимой качалкой
- Присоединиться к пари отжиманий и попасть на доску почета"""


STREAK_FIRST_DAY = "Добро пожаловать в клуб! 💪"
USER_WELCOME_BACK = "{user_as_hlink}, с возвращением!"

STREAK_30_DAYS = """{user_as_hlink}, уважение!
...
STREAK_100_DAYS = """{user_as_hlink}, это уже легенда! 🔥
